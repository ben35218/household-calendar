// Ported verbatim from client/src/utils/canadianHolidays.js. Pure date math (no
// date-fns) so it runs under Hermes. Powers the Holidays settings screen, the
// Events list, and the calendar holiday dots.

export interface HolidayDef {
  id: string;
  name: string;
  group: 'statutory' | 'cultural' | 'multicultural';
}
...
const HANUKKAH: Record<number, string> = {
  2024: '2024-12-25', 2025: '2025-12-14', 2026: '2026-12-04', 2027: '2027-12-24',
  2028: '2028-12-12', 2029: '2029-12-01', 2030: '2030-12-20', 2031: '2031-12-09',
  2032: '2032-11-27', 2033: '2033-12-16', 2034: '2034-12-06', 2035: '2035-11-25',
};
const EID_AL_FITR: Record<number, string> = {
  2024: '2024-04-10', 2025: '2025-03-30', 2026: '2026-03-20', 2027: '2027-03-09',
  2028: '2028-02-26', 2029: '2029-02-14', 2030: '2030-02-04', 2031: '2031-01-24',
  2032: '2032-01-13', 2033: '2033-01-02',
};
const EID_AL_ADHA: Record<number, string> = {
  2024: '2024-06-17', 2025: '2025-06-06', 2026: '2026-05-27', 2027: '2027-05-16',
  2028: '2028-05-05', 2029: '2029-04-24', 2030: '2030-04-13', 2031: '2031-04-02',
  2032: '2032-03-22', 2033: '2033-03-11',
};
...
function getHolidaysForYear(year: number, enabledSet: Set<string>): Holiday[] {
  ...
  add(nthWeekday(year, 5, 0, 2), 'mothers-day');
  add(nthWeekday(year, 6, 0, 3), 'fathers-day');
  add(new Date(year, 9, 31), 'halloween');
  addStr(LUNAR_NEW_YEAR[year], 'lunar-new-year');
  add(new Date(year, 3, 13), 'vaisakhi');
...
export function getCanadianHolidays(fromDate: Date, toDate: Date, enabledIds: string[] | null = null): Holiday[] {
